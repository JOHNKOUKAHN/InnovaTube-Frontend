...
export const SignUp = () => {
  ...
  const startSignup = ({ fullName, userName, email, password, confirmPassword }) => {
    ...
    <>
      <div className="min-h-screen bg-gray-100 flex flex-col justify-center sm:py-12">
        <div className="p-10 xs:p-0 mx-auto md:w-full md:max-w-md">
          ...
          <form onSubmit={(e) => e.preventDefault()} className="bg-white shadow w-full rounded-lg divide-y divide-gray-200">
            <div className="px-5 py-7">
              ...
              <div className="flex flex-col justify-between gap-3">
                <button
                  ...
                  onClick={() => startSignup({ fullName, userName, email, password, confirmPassword })}>
